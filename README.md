...
│   ├── middlewares
│   │   ├── logging.go      # Логирование запроса и ответа
...
| iter4    | Добавлены флаги для конфигурирования сервера и агента | 
| iter5    | Добавлены переменные окружения для конфигурирования сервера и агента | 
| iter6    | Добавлен миддлвар для логирование запросов и ответов сервра | 